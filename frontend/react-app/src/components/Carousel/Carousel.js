              ...
              <div className="carousel-item active">
                ...
                <div className="container">
                  <div className="carousel-caption text-left">
                    <h1>Cities</h1>
                    <p>Browse our database of cities to find out information about local counties and charities</p>
              ...
              <div className="carousel-item">
                ...
                <div className="container">
                  <div className="carousel-caption text-right">
                    <h1>Charities</h1>
                    <p>Discover different charities around the U.S. and find one you would like to contribute to </p>
