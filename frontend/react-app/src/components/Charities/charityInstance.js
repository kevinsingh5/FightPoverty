    ...
    return (
          <div>
              ...
              <ul>
                ...
                <li><a href= 'https://www.charitynavigator.org/index.cfm?bay=content.view&cpid=5593#rating'>CharityNavigator's Accountability Score</a>: {this.props.location.state.charity_navigator_accountability_score} </li>
                <li><a href= 'https://www.charitynavigator.org/index.cfm?bay=content.view&cpid=5593#rating'>CharityNavigator's Financial Score</a>: {this.props.location.state.charity_navigator_financial_score}</li>
